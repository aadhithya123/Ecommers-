...
<body onload='noBack()'>
                ...
                <tbody>
                    <c:forEach items="${categorylist}" var='category'>
                     <tr>
                        ...
                        <td>
                            <a href="/FlyingShopFrontend/edit/${category.categoryid}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="delete/${category.categoryid}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                    <tr>
                    </c:forEach>     
				...
				<form:form method='post' modelAttribute='category' action='addcategory'>
					...
					<div class="modal-body">					
						<div class="form-group">
							...
							<form:input type='text' path='categoryname' class='form-control' required='true'/>
						</div>
						<div class="form-group">
							<label>Category Description</label>
							<form:textarea path="categorydesc" class='form-control' required='true' row="4" cols="50"/>
	...
	<!-- Edit Modal HTML -->
	<div id="edit/${category.categoryid}" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form:form method='post' modelAttribute='categoryedit' action='/FlyingShopFrontend/updatecategory'>
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<label>Category Description</label>
							<form:input type='text' path='categorydesc' class='form-control' required='true'/>
						</div>
						</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
