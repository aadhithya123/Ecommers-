...
Your ID:&nbsp&nbsp&nbsp<form:input type='text' path='productid' value='${productedit.productid}' readonly='true'/>&nbsp&nbsp&nbsp
Your Name:&nbsp&nbsp&nbsp<form:input type='text' path='productname' value='${productedit.productname}'/>&nbsp&nbsp&nbsp
Price:&nbsp&nbsp&nbsp<form:input type='text' path='productprice' value='${productedit.productprice}' />&nbsp&nbsp&nbsp
Quantity:&nbsp&nbsp&nbsp<form:input type='text' path='productquantity' value='${productedit.productquantity}'/>&nbsp&nbsp&nbsp
