...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src= "<c:url value='/resources/image/Carousel11.jpg'/>" width="1200" height="700">
      ...
      <div class="item">
        <img src= "<c:url value='/resources/image/user2.jpg'/>" alt="Chicago" width="1000" height="100">
        <div class="carousel-caption">
          <h3>Ice Cream</h3>
      </div>      
      </div>
      ...
      <div class="item">
        <img src= "<c:url value='/resources/image/user3.jpg'/>" alt="Los Angeles" width="1000" height="100">
        <div class="carousel-caption">
          <h3>Ice Cream</h3>
        </div>      
      </div>
       <div class="item">
        <img src= "<c:url value='/resources/image/user4.jpg'/>" alt="Los Angeles" width="1000" height="100">
        <div class="carousel-caption">
          <h3>Ice Cream</h3>
        </div>      
      </div>
       <div class="item">
        <img src= "<c:url value='/resources/image/user5.jpg'/>" alt="Los Angeles" width="1000" height="100">
        <div class="carousel-caption">
          <h3>Ice Cream</h3>
        </div>      
      </div>
       <div class="item">
        <img src= "<c:url value='/resources/image/user6.jpg'/>" alt="Los Angeles" width="1000" height="100">
        <div class="carousel-caption">
          <h3>Ice Cream</h3>
        </div>      
      </div>
...
<!-- Left and right controls -->
    ...
    <h3 class="h3">THE FROZON SPOON</h3>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#">
                    <a href='prodesc/${prod.productid}'><img height="100" width="100" src='<c:url value="resources/image/${prod.productid}.jpg"/>'/></a>
                    </a>
                    <ul class="social">
                  
                        <li><a href="/FlyingShopFrontend/prodesc/${prod.productid}" data-tip="Quick View"><i class="fa fa-search"></i></a></li>
                        
                        <li><a href="/FlyingShopFrontend/addtocartpro/${prod.productid}?quantity=1" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">${prod.productname}</a></h3>
                    
                    <div class="price">$${prod.productprice}                
            </div>
        </div>
        </div>
        </div></div></div><hr>
...
<div class="container">
  ...
  <div class="footer-copyright text-center py-3">© 2019 Copyright:
    <a href="/FlyingShopFrontend/UserHome"> THEFrozenspoon.com</a>
  </div></div>
</footer>
<!-- Footer -->
<br/>
